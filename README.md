...
### GUI Interface
in order to run and download the GUI you should import our project, in addition you should download the zip file that consists the Ex2.jar, you can find the link in the submission field "Link to Executable jar file". when running the Ex2.jar you should give an existing json file in the same directory, or give a full path to it.
</br>
